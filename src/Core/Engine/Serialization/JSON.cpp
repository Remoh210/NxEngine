...
// 	// 						PropertyVar = objectType.create({"ObjectVar"});
...
// 		// variant var = GameObjectType.create({std::string("test")});
// 		//
...
// 		//
// 		//
// 		// const NString fileToLoadFullPath = Nx::FileSystem::GetRoot() + "/res/Scenes/" + "testReflection" + ".json";
...
//
// 		// for(auto& it : NewGameObject->entity->getAllComponents<BaseComponent>())
// 		// {
// 		// 	//DEBUG_LOG_TEMP("var type: %s", it.get().);
// 		// }
//
// 		
...
// 		//
// 		// 	//variant VarTest = var.get_value<GameObject>();
// 		// 	instance obj = var.get_value<GameObject>();
// 		// 	auto prop_list = obj.get_wrapped_instance().get_type().get_properties();
// 		//
// 		// 	for(auto& it : obj.get_type().get_properties())
// 		// 	{
// 		// 		//DEBUG_LOG_TEMP("var type: %s", it.get_name().to_string().c_str());
