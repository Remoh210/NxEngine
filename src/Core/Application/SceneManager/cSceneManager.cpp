...
//sScene cSceneManager::currentScene;
//
//
//void cSceneManager::RemoveObjectFromScene(EntityHandle entity, ECS& ecs)
//{
//	auto position = std::find(currentScene.sceneObjects.begin(), currentScene.sceneObjects.end(), entity);
//	if (position != currentScene.sceneObjects.end())
//	{
...
//
//
//bool cSceneManager::SaveScene(std::string filename, ECS& ecs, Camera& camera) {
//
...
//		if (!RendComp) { DEBUG_LOG("Next Engine", "ERROR", "No RenderComponent"); return false; }
//		
...
//		if (!TransComp) { DEBUG_LOG("Next Engine", "ERROR", "No TransformComponent"); return false; }
//		
...
//
//
//bool cSceneManager::LoadScene(std::string filename, ECS& ecs, class Camera& camera) {
//
...
//	{
//		RemoveObjectFromScene(currentScene.sceneObjects[i], ecs);
//	}
//	
//	//}
//	//for (const auto& entity : currentScene.sceneObjects)
...
//
//		currentScene.sceneObjects.push_back(entity);
//	}
//
//	return true;
//}
